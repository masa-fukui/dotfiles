...
lvim.keys.insert_mode["jk"] = "<ESC>" -- use ab instead
lvim.keys.normal_mode["Y"] = "y$"
-- <C-a> = Move to start of the line; like in vim comkjmand mode: c_ctrl-b; To insert previously inserted text, use <C-r>. or <Alt-.> (below)
